...
public class ControllerHelper {
	...
	public boolean validarRuc(String ruc) {//retorna falso si es no es valido el ruc
		boolean bandera = false;
		String cedula = "", digito = "";
		cedula = ruc.substring(0, 10);
		digito = ruc.substring(10,ruc.length());
		if(validarDeCedula(cedula)) {
			if(digito.equals("001") || digito.equals("002") || digito.equals("003") || digito.equals("004") || digito.equals("005")) {
				bandera = true;
			}
		}
		return bandera;
