...
public class UsuarioListaC {
	...
	@Command
	public void nuevo(){
		Window ventanaCargar = (Window) Executions.createComponents("/recursos/forms/seguridad/usuarioEditar.zul", null, null);
	...
	public void editar(@BindingParam("usuario") Usuario usuarioSeleccionado){
		...
		Window ventanaCargar = (Window) Executions.createComponents("/recursos/forms/seguridad/usuarioEditar.zul", null, params);
		ventanaCargar.doModal();
	}
